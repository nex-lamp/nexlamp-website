...
cover: images/led-driver-comparison.png
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "不是。隔离驱动安全性最高，但成本和体积也更大。对于有可靠接地、专业维护的场景（如工厂照明），非隔离驱动的性价比更高。关键是根据安全要求、认证需求和成本预算综合判断。"
      }
    },
    {
      "@type": "Question",
      "name": "DOB驱动为什么难以通过3C认证？",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "DOB方案中LED灯珠直接与市电整流后的高压相连，无法满足3C对初级-次级电气隔离的要求。同时，DOB的铝基板需要承受3kVac以上耐压测试，制造难度大、良率低。这是DOB目前主要局限于非认证或认证要求低的出口市场的原因。"
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "智能照明需要接入DALI、Zigbee、蓝牙Mesh等调光控制信号，这些信号线通常与人体可接触的控制面板相连。隔离驱动的输出为安全低压，可以安全地接入调光模块和通信模块，而非隔离和DOB方案的输出端带市电高压，存在触电和通信干扰风险。"
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "不推荐。家用灯具通常没有可靠接地，且用户可能直接触碰灯具金属部分。非隔离驱动输出与市电直通，存在触电风险。家用照明应首选隔离驱动，尤其是面板灯、筒灯等人可触及的灯具。"
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "有限改善。DOB线性IC的固有限制是输出纹波大，加滤波电容可以减轻但无法根除频闪。对于办公、学校等长时间用眼场景，即使改善后仍不建议使用DOB方案。需要无频闪的场景应选择隔离或非隔离开关电源方案。"
      }
    }
  ]
}
